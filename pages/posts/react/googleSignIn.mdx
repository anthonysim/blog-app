...
- <a target="_blank" href="https://developers.google.com/identity/sign-in/web/reference" style={{ color: "blue" }}>Official Reference</a>
- <a target="_blank" href="https://github.com/anthonysim/google-gapi-signin" style={{ color: "blue" }}>Github Repo</a>

<br/>

**Step 1: Add the following script to your index.html**

<CopyCodeBlock text={'<script src="https://apis.google.com/js/platform.js" async defer></script>'}/>
...
```
// loads and initates when App is "mounted"
useEffect(() => {
